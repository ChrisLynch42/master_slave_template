...
ActiveRecord::Schema.define(version: 20131017131051577577788817) do
  ...
  create_table "campaigns_scenarios", force: true do |t|
  ...
  create_table "characters_armors", force: true do |t|
  ...
  create_table "characters_class_attributes", force: true do |t|
    t.integer  "character_id"
  ...
  create_table "characters_equipment", force: true do |t|
    t.integer  "character_id"
  ...
  create_table "characters_race_attributes", force: true do |t|
    t.integer  "character_id"
  ...
  create_table "scenarios_characters", force: true do |t|
    t.integer  "character_id"
    t.integer  "scenario_id"
    t.datetime "created_at"
    t.datetime "updated_at"
